...
<nav class="navbar navbar-light bg-body-tertiary shadow-lg">
  ...
  <ul class="navbar-nav">
          ...
          <li class="nav-item" style="color: white;">
            <a class="nav-link" href="<?php echo e(route('todos.create')); ?>" style="color: white;">Add List</a>
          </li>
        </ul>
  </div>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\web_project\resources\views/user/settings.blade.php ENDPATH**/ ?>