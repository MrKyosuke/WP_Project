...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel" style="width: 20%;">
  ...
  <div class="container d-flex justify-content-center" style="padding-top: 5%">
    <form method="POST" action="<?php echo e(route('todos.store')); ?>" class="col-md-6 border p-4 rounded shadow-lg">
      <?php echo csrf_field(); ?>
      <div class="mb-3">
      ...
      <div class="d-flex justify-content-center p-1">
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-secondary flex-grow-1">back</a>
      </div>
    </form>
  </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\web_project\resources\views/todos/create.blade.php ENDPATH**/ ?>